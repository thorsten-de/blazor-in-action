...
public class GetTrailHandler([FromKeyedServices(Constants.SecureAPIClient)] HttpClient httpClient) : IRequestHandler<GetTrailRequest, GetTrailRequest.Response>
{
